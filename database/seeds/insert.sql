...
insert into users(cpf, name, email, password) values('2222222', 'teste', 'teste@mail.com', '123456');
insert into agencia(cnpj, razao_social, users_cpf) values ('22212121', 'Corumba agencia', '2222222');
insert into endereco(bairro, cep, cidade, estado, numero, logradouro) values ('Centro', '79303060', 'Corumba', 'MS', '55', 'Rua Dom Aquino');
insert into agencia_has_endereco(agencia_cnpj, endereco_idendereco) values('22212121', 1);
insert into telefone(numero) values('3232-2061');
insert into agencia_has_telefone(agencia_cnpj, telefone_idtelefone) values('22212121', 1);
...
insert into carro(placa, modelo, ano, numero_portas, numero_assento, cor, descricao, km, combustivel, cambio, valor_diaria, status, marca_idmarca, agencia_cnpj, categoria_idcategoria)
	values('KBO-8601', 'Uno', 2015, 4, 4, 'Branco', 'Carro confortável e economico', 10.000, 'FLEX', 'MANUAL', 88.00, 'D', 1, '22212121', 1);
